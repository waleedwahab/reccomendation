...
console.log("this is seller",user);
  ...
  accept=".xlsx,.xls,image/*,.doc, .docx,.ppt, .pptx,.txt,.pdf,.zip,.rar,.7zip"
/>
                ...
                <div className={styles.footer}>  <Button variant='contained' type='submit' sx={{ margin: '15px' }}>Sell</Button></div>
            </form>
        </div>
    )
}
